...
import { predictCKDRisk, type PredictionResult } from "@/lib/prediction-models"
...
import { Droplets, AlertTriangle, CheckCircle, Info, ArrowRight, RefreshCw } from "lucide-react"

export default function CKDRiskPage() {
  ...
  const runAnalysis = () => {
    ...
    setTimeout(() => {
      const prediction = predictCKDRisk(selectedPatient)
  ...
  return (
    <AppShell
      ...
      subtitle="Binary classification for early detection of reduced kidney function"
    >
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Evaluates risk of reduced kidney function (eGFR {"<"} 60) using clinical markers
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div className="p-4 rounded-lg bg-secondary">
                ...
                <p className="text-lg font-semibold">eGFR, Creatinine, Albumin</p>
              </div>
              <div className="p-4 rounded-lg bg-secondary">
                <p className="text-sm font-medium text-muted-foreground">Clinical Use</p>
                <p className="text-lg font-semibold">Early Detection & Referral</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="mt-4 p-4 rounded-lg bg-secondary">
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div>
                    ...
                    <p className="text-xl font-semibold">{selectedPatient.egfr}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Creatinine</p>
                    <p className="text-xl font-semibold">{selectedPatient.creatinine} mg/dL</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Urine Albumin</p>
                    <p className="text-xl font-semibold">{selectedPatient.albumin} mg/L</p>
                  </div>
                  <div>
