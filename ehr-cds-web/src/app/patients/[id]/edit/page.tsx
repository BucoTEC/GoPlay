...
export default function EditPatientPage({
  ...
  useEffect(() => {
    if (patient) {
      setFormData({
        ...
        hypertensionHistory: patient.hypertensionHistory,
        familyHistoryCardiac: patient.familyHistoryCardiac,
  ...
  return (
    <AppShell title={`Edit ${patient.firstName} ${patient.lastName}`} subtitle={`MRN: ${patient.mrn}`}>
            ...
            <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "active" | "inactive" | "critical") =>
